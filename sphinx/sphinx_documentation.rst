...
Deploy page
------------
Using the terminal within the 'sphinx' directory, type ``make clean`` and then followed by ``make html``. This creates the HTML equivaleny
files for the '*.rst' files within the 'sphinx/_build/html' directory. Copy-paste the contents within the 'sphinx/_build/html' directory into 
the 'docs' directory in the project. Commit the changes into your GitHub project repository and see the changes reflected on 
the `documentation page <https://mapping-commons.github.io/sssom-py/index.html>`_

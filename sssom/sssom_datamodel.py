...
class MappingSet(YAMLRoot):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self.creator_id = [
            v if isinstance(v, URIorCURIE) else URIorCURIE(v) for v in self.creator_id
        ]
...
class Mapping(YAMLRoot):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self.author_id = [
            v if isinstance(v, URIorCURIE) else URIorCURIE(v) for v in self.author_id
        ]
        ...
        self.reviewer_id = [
            v if isinstance(v, URIorCURIE) else URIorCURIE(v) for v in self.reviewer_id
        ]

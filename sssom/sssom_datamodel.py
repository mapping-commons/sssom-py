    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if not isinstance(self.mapping_set_source, list):
            self.mapping_set_source = (
                [self.mapping_set_source]
                if self.mapping_set_source is not None
                else []
            )
        self.mapping_set_source = [
        ...
        if not isinstance(self.creator_id, list):
            self.creator_id = (
                [self.creator_id] if self.creator_id is not None else []
            )
        self.creator_id = [
            v if isinstance(v, URIorCURIE) else URIorCURIE(v)
        ...
        if self.mapping_provider is not None and not isinstance(
            self.mapping_provider, URIorCURIE
        ):
        ...
        if not isinstance(self.object_match_field, list):
            self.object_match_field = (
                [self.object_match_field]
                if self.object_match_field is not None
                else []
            )
        self.object_match_field = [
            v if isinstance(v, MatchFieldEnum) else MatchFieldEnum(v)
        ...
        self.subject_preprocessing = [
            v
            if isinstance(v, PreprocessingMethodEnum)
            else PreprocessingMethodEnum(v)
        ...
        if not isinstance(self.see_also, list):
            self.see_also = (
                [self.see_also] if self.see_also is not None else []
            )
        self.see_also = [
...
class Mapping(YAMLRoot):
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        if not isinstance(self.match_type, list):
            self.match_type = (
                [self.match_type] if self.match_type is not None else []
            )
        self.match_type = [
        ...
        if not isinstance(self.author_id, list):
            self.author_id = (
                [self.author_id] if self.author_id is not None else []
            )
        self.author_id = [
            v if isinstance(v, URIorCURIE) else URIorCURIE(v)
        ...
        if self.semantic_similarity_measure is not None and not isinstance(
            self.semantic_similarity_measure, URIorCURIE
        ):
            self.semantic_similarity_measure = URIorCURIE(
...
class MappingCardinalityEnum(EnumDefinitionImpl):
    ...
    def _addvals(cls):
        setattr(
            cls,
            "1:1",
            PermissibleValue(text="1:1", description="One-to-one mapping"),
        )
        setattr(
            cls,
            "1:n",
            PermissibleValue(text="1:n", description="One-to-many mapping"),
        )
        setattr(
            cls,
            "n:1",
            PermissibleValue(text="n:1", description="Many-to-one mapping"),
        )
        setattr(
            cls,
            "1:0",
            PermissibleValue(text="1:0", description="One-to-none mapping"),
        )
        setattr(
            cls,
            "0:1",
            PermissibleValue(text="0:1", description="None-to-one mapping"),
        )
        setattr(
            cls,
            "n:n",
            PermissibleValue(text="n:n", description="Many-to-many mapping"),
        )
...
class MatchTypeEnum(EnumDefinitionImpl):
    ...
    Unspecified = PermissibleValue(
        text="Unspecified", description="Unknown match type"
    )
